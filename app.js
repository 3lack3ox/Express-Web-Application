...
const DB = process.env.MONGODB_URI; //load db password from environment variables
...
const dbError = error + `\tEncountered an error while connecting to database! Make sure that you stored your MongoDB connection string in .env`;
